...
namespace GameDemo
{
    class Program
    {
        ...
        {
            IGamer player1 = new OldGamer() { TcNo = "1", BirthYear = 1999, GamerName = "İbrahim", GamerSurname = "NUH", MembershipYear = 2 };
            IGamer player2 = new OldGamer() { TcNo = "2", BirthYear = 1985, GamerName = "Muhammed", GamerSurname = "NUH", MembershipYear = 20 };
